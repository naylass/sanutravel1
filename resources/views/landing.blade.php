...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Cegah overflow horizontal tanpa mempengaruhi fixed elements */
        ...
        .btn-ghost-sm {
            ...
            text-decoration: none; padding: .48rem 1.1rem;
        ...
        .hero-glow-1 {
            ...
            background: radial-gradient(circle, rgba(37,99,235,.26) 0%, transparent 70%);
        ...
        .hero-glow-2 {
            ...
            bottom: -120px; right: 8%; pointer-events: none;
        }
        .hero-inner {
        ...
        .hero-badge {
            ...
            border-radius: 999px; padding: .4rem 1.15rem; margin-bottom: 2rem;
        }
        .hero-badge-dot {
        ...
        .hero-sub {
            ...
            font-weight: 400; max-width: 540px; margin: 0 auto 2.75rem;
        }
        .hero-actions {
        ...
        .btn-hero-primary {
            display: inline-flex; align-items: center; gap: .5rem;
            background: linear-gradient(135deg, var(--brand), var(--brand-light));
            color: #fff; padding: .95rem 1.9rem;
        ...
        .btn-hero-ghost {
            ...
            color: rgba(255,255,255,.75); padding: .95rem 1.6rem;
            border-radius: 13px; font-size: 14px; font-weight: 500;
            text-decoration: none; transition: all .2s;
        }
        .btn-hero-ghost:hover { background: rgba(255,255,255,.14); color: #fff; border-color: rgba(255,255,255,.3); }

        /* ── STATS STRIP ─────────────────────────────────────── */
        /* Dibungkus dalam strip penuh lebar, card di dalam max-width */
        .stats-strip-wrap {
            width: 100%;
            background: #fff;
        ...
        .stat-emoji { font-size: 24px; margin-bottom: .55rem; }
        .stat-label { font-size: 15px; font-weight: 700; color: var(--ink); margin-bottom: .25rem; }
        .stat-desc { font-size: 13px; color: var(--ink-4); }
        /* ─────────────────────────────────────────────────────── */
        ...
        .section-title {
            font-size: clamp(1.85rem, 3vw, 2.75rem); font-weight: 800;
        ...
        .svc-card {
            border-radius: 26px; padding: 2.25rem; position: relative; overflow: hidden;
        ...
        .svc-badge {
            display: inline-block; font-size: 11px; font-weight: 700;
            padding: .3rem .9rem; border-radius: 999px; margin-bottom: 1.35rem;
        }
        .svc-icon { font-size: 2.4rem; margin-bottom: 1rem; }
        .svc-name { font-size: 1.75rem; font-weight: 800; margin-bottom: .5rem; letter-spacing: -.02em; }
        .svc-desc { font-size: 14.5px; line-height: 1.7; margin-bottom: 2rem; }
        .svc-footer { display: flex; align-items: flex-end; justify-content: space-between; gap: 1rem; }
        .svc-price-small { font-size: 11px; margin-bottom: .3rem; }
        .svc-price { font-size: 1.6rem; font-weight: 800; letter-spacing: -.02em; }
        .svc-price small { font-size: 12.5px; font-weight: 400; }
        .btn-svc {
        ...
        /* ── STEPS ── */
        .steps-section { background: #fff; padding: 88px 2.5rem; }
        .steps-grid {
        ...
        .step-card {
            ...
            border-radius: 22px; padding: 1.9rem 1.4rem; text-align: center;
        ...
        .step-emoji { font-size: 2.1rem; margin: .5rem 0 .8rem; }
        ...
        .feature-list { display: flex; flex-direction: column; gap: .85rem; margin-top: 2rem; }
        .feature-row {
        ...
        .feature-desc { font-size: 13px; color: var(--ink-4); line-height: 1.6; }

        /* ── TESTIMONIALS ── */
        .testi-section { background: linear-gradient(180deg, var(--surface), #EEF2FF); padding: 88px 2.5rem; }
        .testi-grid {
            display: grid; grid-template-columns: repeat(3, 1fr);
            gap: 1.35rem; margin-top: 3rem;
        }
        .testi-card {
            background: #fff; border: 1px solid var(--border); border-radius: 22px; padding: 1.6rem;
        ...
        .testi-text { font-size: 14px; color: var(--ink-3); line-height: 1.7; font-style: italic; margin-bottom: 1.35rem; }
        ...
        /* ── CTA ── */
        .cta-section { padding: 88px 2.5rem; }
        .cta-block {
            max-width: 1400px; margin: 0 auto;
            background: linear-gradient(145deg, #0F1B35, #0A1228);
            border: 1px solid rgba(37,99,235,.2); border-radius: 32px; padding: 5.5rem 3rem;
        ...
        .cta-sub {
            font-size: 15.5px; color: rgba(255,255,255,.45); line-height: 1.7;
            max-width: 460px; margin: 0 auto 2rem;
        }
        .btn-cta {
            display: inline-flex; align-items: center; gap: .5rem;
            background: #fff; color: var(--ink); padding: .95rem 2.1rem;
        ...
        .mobile-sticky a {
            ...
            background: linear-gradient(135deg, var(--brand), var(--brand-light));
            color: #fff; padding: .95rem; border-radius: 13px;
        ...
        @media (max-width: 768px) {
            ...
            .stats-strip-inner { grid-template-columns: 1fr; padding: 0 1.25rem; }
...
<!-- STATS STRIP — full width, tidak terpotong -->
    ...
    <div class="section-inner">
        ...
        <div class="services-grid">
            ...
            <div class="svc-card svc-light">
                <div style="position:absolute;top:0;right:0;width:180px;height:180px;border-radius:50%;background:radial-gradient(circle,rgba(245,158,11,.08),transparent);transform:translate(30%,-30%)"></div>
                <div style="position:relative;z-index:1">
